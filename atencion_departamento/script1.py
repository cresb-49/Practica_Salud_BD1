...
path_entrada = "E:/PROYECTOS/Practica_Salud_BD1/atencion_departamento"
path_salida = "E:/PROYECTOS/Practica_Salud_BD1/atencion_departamento"

# Cargamos el archivo CSV base
df = pd.read_csv(os.path.join(path_entrada, "atencion_por_departamento.csv"))
